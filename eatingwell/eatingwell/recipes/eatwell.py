...
class RecipeInstruction:
    ...
    def __init__(self, type: Optional[str], image: Optional[List[ImageElement]], text: Optional[str]) -> None:
        self.type = type
        self.image = image
        self.text = text
...
class Video:
    ...
    def __init__(self, type: Optional[str], content_url: Optional[str], description: Optional[str], duration: Optional[str], name: Optional[str], thumbnail_url: Optional[str], upload_date: Optional[datetime]) -> None:
        self.type = type
    ...
    def from_dict(obj: Any) -> 'Video':
        ...
        return Video(type, content_url, description, duration, name, thumbnail_url, upload_date)
...
class RecipeElement:
    ...
    def from_dict(obj: Any) -> 'RecipeElement':
        ...
        return RecipeElement(context, type, headline, date_published, date_modified, author, description, image, video, publisher, name, aggregate_rating, nutrition, prep_time, recipe_ingredient, recipe_instructions, recipe_yield, total_time, main_entity_of_page, about)
